...
- Decision Making with Probabilities.
    ...
    - Expected Value with Sample Information (EVPI)
...
- **At Chance Nodes 6, 7, and 8**: Calculate conditional probabilities for demand given a favorable report:
...
These are **posterior probabilities**, reflecting updated likelihoods based on favorable market research.

:::

- **At Chance Nodes 9, 10, and 11**: Calculate conditional probabilities for demand given an unfavorable report:
...
- $P(F | s_1)$: Probability of receiving a **favorable market research report** given that **strong demand** exists.

:::

:::{.fragment}
  
To complete the probability calculations, we require all conditional probabilities for each sample outcome given each state of nature.
...
## Branch Probabilities for Favorable Report 
...
## Branch Probabilities for Unfavorable Report 
...
<center>
Branch probabilities based on an unfavorable market research report
</center>
...
Using Bayes' theorem within the decision tree allows PDC to incorporate market research data into decision-making, thereby refining prior probability estimates with sample information.

- By recalculating probabilities at each chance node based on new data, PDC can adjust its decision strategy dynamically.

- The resulting **posterior probabilities** provide a clearer understanding of potential outcomes, enabling PDC to select the optimal path based on updated insights.

- Overall, Bayes' theorem enhances decision-making by leveraging both initial assessments and new information, leading to more accurate, data-driven decisions.

- The use of Bayes’ theorem in decision trees showcases the value of combining probability updates with structured decision-making to support informed, strategic choices.

- This structure provides a logical flow from theory (Bayes’ theorem) to application (calculating probabilities) and concludes with a summary of the strategic benefits.
