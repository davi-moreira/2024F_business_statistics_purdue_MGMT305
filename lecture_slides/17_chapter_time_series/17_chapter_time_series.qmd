...
| 6. Linear Regression Model: Lag Variable  |            |      X        | X                |     X     |         X          |
| 7. Linear Regression Model: Time as Independent Variable |     | X           |                 |          |                   |
| 8. Linear Regression Model: Time as Independent Variable with Transformation                |            |              |       X           |         |                   |
| 9. Linear Regression Model: Season as Independent Variable |          |              |                  | X        |                   |
| 10. Linear Regression Model: Time and Season as Independent Variables | |             |                  |          | X                 |
